 ...
 * \example Tricky<int, 2> prng(0, 10); // Generates a random number in the range [0, 10], forbids a number to be generated 2 times after it was generated
 * \example Tricky<int, 0> prng(0, 10); // Generates a random number in the range [0, 10], forbids a number to be generated 0 times after it was generated (equivalent to Uniform::integral)
 * \param min minimum value of the range (inclusive)
 * \param max maximum value of the range (inclusive)
 * \return T random number in the range [min, max]
 */
